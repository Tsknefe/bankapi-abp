...
namespace BankApiAbp.Migrations
{
    ...
    [Migration("20260331081317_Added_Transfer_Notification_Log")]
    partial class Added_Transfer_Notification_Log
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankApiAbp.Banking.BankingIdempotencyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BankingIdempotencyRecords", (string)null);
                });

            modelBuilder.Entity("BankApiAbp.Banking.Messaging.InboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BankingInboxMessages", (string)null);
                });

            modelBuilder.Entity("BankApiAbp.Banking.Messaging.TransferAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BankApiAbp.Entities.LedgerEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BankApiAbp.Transactions.Transaction", b =>
                {
                    ...
                    b.ToTable("Transactions", null, t =>
                        {
                            t.HasCheckConstraint("CK_Transactions_Owner", "\"AccountId\" IS NOT NULL OR \"DebitCardId\" IS NOT NULL OR \"CreditCardId\" IS NOT NULL");
                        });
                });
            ...
            modelBuilder.Entity("BankApiAbp.Cards.CreditCard", b =>
                {
                    b.HasOne("BankApiAbp.Entities.Customer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BankApiAbp.Cards.DebitCard", b =>
                {
                    b.HasOne("BankApiAbp.Entities.Account", null)
                        .WithMany()
